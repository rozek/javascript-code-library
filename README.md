...
| `JCL.ui` | preact/htm re-exports, hooks, layout & content primitives, and ~125 `native`/`styled`/`legacy` UI components, plus the `<jcl-applet>` custom element | [ui-programming-manual.md](docs/ui-programming-manual.md) | [ui-api-reference.md](docs/ui-api-reference.md) |
...
> first cut and will be extended over time - in particular, the ~125
